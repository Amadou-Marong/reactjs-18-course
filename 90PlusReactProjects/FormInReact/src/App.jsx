      ...
      <div className="w-full h-full flex items-center justify-center bg-gray-100 min-h-screen">
        <form action="" className="min-w-98 p-6 border-gray-300 rounded-lg bg-white shadow-lg">
            ...
            <div className="my-2">
                ...
                <input type="text" name="contact" id="contact" placeholder="Enter Contact" className="p-2 rounded w-full border border-gray-300 capitalize outline-none placeholder-gray-400"/>
            </div>
        </form>
      </div>
    </>
